...
\def\Authors{Juan-Julián Merelo-Guervós\,$^{1,2,*}$, P.A. Castillo\,$^{1,2}$, Mario Garc\'ia-Valdez\,$^{3}$ and Co-Author\,$^{1,2}$}
...
$^{3}$ Dept. of Graduate Studies, Instituto Tecnol\'ogico de Tijuana (Mexico) }
...
% We could change the current citation (the one that appears in the
% References section) by the paper by K. Meri et al
% (http://dblp.uni-trier.de/rec/bibtex/journals/nc/MeriAMGCGL13) <=
% \cite{mericloud} in geneura.bib
% OK - JJ
